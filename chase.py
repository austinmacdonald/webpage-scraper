...
chase_dict = []
texts = [tag.get_text() for tag in soup.findAll('p')]

purchase_apr_text = texts[3]
purchase_apr_nums = utils.extractNums(purchase_apr_text)

bt_apr_text = texts[5]
bt_apr_nums = utils.extractNums(bt_apr_text)
...
prime_rate_nums = utils.extractNums(prime_rate_text)
